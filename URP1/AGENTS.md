...
- L17 天空整屏泛光已从算法层修复：体积积分先计算视线与局部体积盒真实交段，天空路径固定限制为 96m，并对天空消光/散射独立降权；太阳附近额外叠加带角度遮罩和能量上限的米氏前向散射瓣，因此 Coverage=0 时仍有局部太阳光晕，但远离太阳不会整屏乳白。A/B 预览：`Assets/Screenshots/L18_clear_sky_bounded_mie_20260622.png`、`Assets/Screenshots/L18_clear_sky_bounded_mie_no_cloud_20260622.png`。
