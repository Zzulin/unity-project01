...
- L18 色调已从深蓝黑暴风风格调整为现实傍晚参考：后处理取消高对比蓝黑压暗，改为轻微冷色平衡；程序天空降低大气厚度与曝光，环境光和雾提升为明亮蓝灰；主光改为接近中性的暖白，暖色集中在云受光与体积散射；地面暗部恢复可读。色调预览：`Assets/Screenshots/L18_real_world_warm_blue_final_20260620.png`。
