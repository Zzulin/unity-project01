...
- L18 当前主光角度固定为场景现值 `(68.00003, 192.52899, 180)`，不再为曝光问题调整方向；针对视线与太阳方向接近时的爆白，L13/L17 增加了默认不影响原场景的前向散射峰值上限，L18 分别使用 `0.12` 与 `1.35`，L13 同时限制最终太阳直射项，并启用 ACES。L17 户外介质盒为中心 Y=75/高度 190，顶部 Y=170 与 L13 云底约 Y=160 软衔接，当前 Density 0.0042 / Intensity 6.5，在保留云缝光幕的同时避免抬头射线在云层上方介质中长距离累积。固定视角和相机上仰 25° 压力测试均不再整屏爆白，截图为 `Assets/Screenshots/L18_view_aligned_sun_final_20260619.png` 与 `Assets/Screenshots/L18_look_up_exposure_final_20260619.png`。
