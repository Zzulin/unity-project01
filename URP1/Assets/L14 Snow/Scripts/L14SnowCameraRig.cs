...
public sealed class L14SnowCameraRig : MonoBehaviour
{
    ...
    [Min(0.1f)] public float minDistance = 7f;
    [Min(0.1f)] public float maxDistance = 72f;
    public float yaw = -20f;
    [Range(8f, 78f)] public float pitch = 35f;
